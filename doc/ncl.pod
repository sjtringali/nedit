...
available. This overrides the X resource `nc.autoStart' (or `NEditClient.autoStart').
...
the X resource `nc.serverCommand' (or `NEditClient.serverCommand'), by default, I<"nedit -server">.
...
Default: 10 seconds. Also settable via the X resource `nc.timeOut' (or `NEditClient.timeOut').
